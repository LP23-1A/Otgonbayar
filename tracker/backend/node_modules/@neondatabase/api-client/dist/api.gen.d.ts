...
/** @example {"id":"spring-example-302709","platform_id":"aws","region_id":"aws-us-east-2","name":"spring-example-302709","provisioner":"k8s-pod","pg_version":15,"proxy_host":"us-east-2.aws.neon.tech","store_passwords":true,"creation_source":"console","history_retention_seconds":604800,"created_at":"2022-12-13T01:30:55Z","updated_at":"2022-12-13T01:30:55Z"} */
...
export interface DowngradeSubscriptionResponseLimitsUnsatisfied {
    limits: {
        name: string;
        expected: string;
        actual: string;
...
export interface DowngradeSubscriptionParams {
    /** Only checks limits, doesn't downgrade subscription */
    dry_run?: boolean;
}
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     * @secure
     */
    getProjectLimits: (projectId: string, params?: RequestParams) => Promise<AxiosResponse<ProjectLimits, any>>;
    /**
     ...
     * @secure
     */
    downgradeSubscription: (query: DowngradeSubscriptionParams, data: DowngradeSubscriptionRequest, params?: RequestParams) => Promise<AxiosResponse<object, any>>;
    /**
