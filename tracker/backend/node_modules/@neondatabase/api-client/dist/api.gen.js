...
(function (BillingSubscriptionType) {
    ...
    BillingSubscriptionType["Free"] = "free";
...
var Api = /** @class */ (function (_super) {
    ...
    function Api() {
         ...
         * @secure
         */
        _this.listBillingInvoices = function (params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/billing/invoices", method: "GET", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @secure
         */
        _this.listUserAvailableApplications = function (query, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/applications", method: "GET", query: query, secure: true, format: "json" }, params));
        };
        /**
         ...
         * @secure
         */
        _this.unlinkProjectFromVercelIntegrations = function (projectId, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/projects/".concat(projectId, "/applications/vercel"), method: "DELETE", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @secure
         */
        _this.revokeOAuthConsent = function (clientId, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/applications/oauth/".concat(clientId), method: "DELETE", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @secure
         */
        _this.runProjectQuery = function (projectId, data, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/projects/".concat(projectId, "/query"), method: "POST", body: data, secure: true, type: ContentType.Json, format: "json" }, params));
        };
        /**
         ...
         * @secure
         */
        _this.listProjectSavedQueries = function (projectId, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/projects/".concat(projectId, "/saved_queries"), method: "GET", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @secure
         */
        _this.createSavedQuery = function (projectId, data, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/projects/".concat(projectId, "/saved_queries"), method: "POST", body: data, secure: true, type: ContentType.Json, format: "json" }, params));
        };
        /**
        ...
        _this.listProjectPermissions = function (projectId, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/projects/".concat(projectId, "/permissions"), method: "GET", secure: true, format: "json" }, params));
        };
        /**
        ...
        _this.grantPermissionToProject = function (projectId, data, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/projects/".concat(projectId, "/permissions"), method: "POST", body: data, secure: true, type: ContentType.Json, format: "json" }, params));
        };
        /**
        ...
        _this.revokePermissionFromProject = function (projectId, permissionId, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/projects/".concat(projectId, "/permissions/").concat(permissionId), method: "DELETE", secure: true, format: "json" }, params));
        };
        /**
         * @description Return project's limits
         *
         * @tags Project, Limits, Frontend
         * @name GetProjectLimits
         * @summary Return project's limits
         * @request GET:/projects/{project_id}/limits
         * @secure
         */
        _this.getProjectLimits = function (projectId, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/projects/".concat(projectId, "/limits"), method: "GET", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @secure
         */
        _this.updateProjectSavedQuery = function (savedQueryId, data, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/saved_queries/".concat(savedQueryId), method: "PATCH", body: data, secure: true, type: ContentType.Json, format: "json" }, params));
        };
        /**
         ...
         * @secure
         */
        _this.deleteSavedQuery = function (savedQueryId, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/saved_queries/".concat(savedQueryId), method: "DELETE", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @secure
         */
        _this.getProjectQueryHistory = function (_a, params) {
            var projectId = _a.projectId, query = __rest(_a, ["projectId"]);
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/projects/".concat(projectId, "/query/history"), method: "GET", query: query, secure: true, format: "json" }, params));
        };
        /**
        ...
        /**
         * @description Retrieves a list of roles from the specified branch. You can obtain a `project_id` by listing the projects for your Neon account. You can obtain the `branch_id` by listing the project's branches. In Neon, the terms "role" and "user" are synonymous. For related information, see [Manage users](https://neon.tech/docs/manage/users/).
         *
         * @tags Branch
         ...
         * @secure
         */
        _this.authProjectEndpointPasswordlessSession = function (projectId, endpointId, data, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/projects/".concat(projectId, "/endpoints/").concat(endpointId, "/passwordless_auth"), method: "POST", body: data, secure: true, type: ContentType.Json }, params));
        };
        /**
         * @description Note, this is a preview API and could be subjected to significant changes in the future. Retrieves a list of per-project consumption for the current billing period.
         *
         * @tags Preview
         ...
         * @secure
         */
        _this.getCurrentUserConsumption = function (query, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/users/me/consumption", method: "GET", query: query, secure: true, format: "json" }, params));
        };
        /**
         * No description
         *
         ...
         * @request POST:/subscriptions/downgrade
         * @secure
         */
        _this.downgradeSubscription = function (query, data, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/subscriptions/downgrade", method: "POST", query: query, body: data, secure: true, type: ContentType.Json, format: "json" }, params));
        };
        /**
         ...
         * @secure
         */
        _this.healthCheck = function (params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/healthz", method: "GET", secure: true }, params));
        };
        return _this;
    }
    return Api;
