    ...
    return(
        <section className="max-sm:hidden h-[900px]">
            <div className="relative">
                ...
                <div className="absolute top-[630px] left-[20px] w-[598px] h-[252px] bg-white rounded-[12px]">
            ...
            <div className="w-[1240px] relative flex justify-end top-[930px]">
                <div className="w-[90px] flex gap-[9px]">
                    <button onClick={left} className="w-[40px] h-[40px] flex items-center justify-center border-2 rounded-[6px] hover:bg-[#cccdd3]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="9" height="17" viewBox="0 0 9 17" fill="none">
                        <path d="M8.5 16L1 8.5L8.5 1" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </button>
                    <button onClick={right} className="w-[40px] h-[40px] flex items-center justify-center border-2 rounded-[6px] hover:bg-[#cccdd3]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="9" height="17" viewBox="0 0 9 17" fill="none">
